...
export default class NobucaTabsModel extends NobucaPositionAndSizeModel {
    constructor() {
        ...
        this.createTabEventEmitter = new NobucaUiEventEmitter();
        this.activeTabChangeEventEmitter = new NobucaUiEventEmitter();
        this.removeTabEventEmitter = new NobucaUiEventEmitter();
        this.lastActiveTabs = [];
    }
